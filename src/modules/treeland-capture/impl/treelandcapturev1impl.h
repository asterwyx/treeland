...
public:
    ...
    WAYLIB_SERVER_NAMESPACE::WSurface *mask {nullptr}; // mask should be created so there must exist a wsurface
...
void handle_treeland_capture_frame_v1_destroy(wl_client *client,
                                              wl_resource *resource);
...
void handle_treeland_capture_manager_v1_destroy(wl_client *client,
                                                wl_resource *resource);
